...
class qa_html_theme_layer extends qa_html_theme_base {
	function head_css(){
		...
		if (qa_request() === 'reports' || qa_request() === 'reports-monthly' || qa_request() === 'reports-hourly' || qa_request() === 'recent-activity'){
			$this->output('
				<link rel="stylesheet" href="./qa-plugin/reports/assets/jquery-ui.min.css">
				<style>
					.qa-sidepanel{
						display: none;
					}
		...
		if (qa_request() === 'reports' || qa_request() === 'reports-monthly' || qa_request() === 'reports-hourly'){
			$this->output('
				<link href="./qa-plugin/reports/assets/c3.min.css" rel="stylesheet" type="text/css">');
		}
		else if (qa_request() === 'recent-activity'){
			$this->output('
				<link href="./qa-plugin/reports/assets/datatables/datatables.min.css" rel="stylesheet" type="text/css">');
			}
	}
	function head_script(){
		qa_html_theme_base::head_script();
		if(qa_request() === 'reports' || qa_request() === 'reports-monthly' || qa_request() === 'reports-hourly' || qa_request() === 'recent-activity'){
					$this->output('<script src="./qa-plugin/reports/assets/jquery-ui.min.js"></script>
					<script src="./qa-plugin/reports/reports.js"></script>
					<script>
		...
		if(qa_request() === 'reports' || qa_request() === 'reports-monthly' || qa_request() === 'reports-hourly'){
			$this->output('<script src="./qa-plugin/reports/assets/d3.min.js" charset="utf-8"></script>
				<script src="./qa-plugin/reports/assets/c3.min.js"></script>');
		}
		else if (qa_request() === 'recent-activity'){
			$this->output('<script src="./qa-plugin/reports/assets/datatables/datatables.min.js" charset="utf-8"></script>');
		}
	}
}
